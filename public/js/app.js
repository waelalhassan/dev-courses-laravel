...
// get DOM
var courses_parent = document.querySelector("#courses_parent"),
    top_navbar = document.querySelector("#top_navbar"),
    header_btn_action = document.querySelector("#header_btn_action"),
    categories_parent = document.querySelector("#categories_parent"); // make navbar fixed when scroll
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          getCurrentFilter = function _getCurrentFilter(id) {
            var dataFilter = responseCourses.filter(function (d) {
              return d.cat_id == id;
            });
        ...
        case 7:
          apiCategories = _context.sent;
          _context.next = 10;
          return apiCourses.json();

        case 10:
          responseCourses = _context.sent;
          _context.next = 13;
        ...
        case 13:
          ...
          for (i in responseCategories) {
            if (i == 0) {
              cache_c += "<li class=\"active\" data-filter=\"-1\"> All </li>";
            }

            cache_c += "<li data-filter=\"".concat(responseCategories[i].id, "\" > ").concat(responseCategories[i].name, " </li>");
          }

          if (categories_parent) categories_parent.innerHTML = cache_c;
          if (categories_parent) Array.from(categories_parent.children).forEach(function (ele, i) {
            ele.onclick = function () {
              getCurrentFilter(ele.getAttribute("data-filter"));
              var a = 0;

              while (a < categories_parent.children.length) {
                var d = categories_parent.children[a++];
